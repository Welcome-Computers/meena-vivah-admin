...
export default async function PersonalDetails(
  ...
  try {
    const { name, dob, education, occupation, gender,
       father_occupation, father_name, mother_name, mother_occupation, 
       sibling_details, address_details, other_gotra, gotra_self, gotra_mother, gotra_grandmother, gotra_grandmother_maternal, preferences, mobile_details, other_details, type,
    } = req.body;
    ...
    const [result]: any = await connection.query(
      ...
      [ mobile, gender, name, dob, education, occupation, father_name,
         mother_name, father_occupation,
         mother_occupation, gotra_self, gotra_mother, gotra_grandmother, 
         gotra_grandmother_maternal, preferences, other_details,
      ],
    );
